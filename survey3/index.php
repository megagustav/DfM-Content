<?php   ob_start();
        ...
        $title = "Product Association Survey";
...
?>
	...
	<section class="container pb-5 mb-5 intro">
        ...
        <div class="tables">
          ...
          <h1 class="col-12">Designing User Experience in Autonomous Cars &mdash; Image Association Survey</h1>
                                
          <h3 class="px-3 instructions">According to the definitions of <i>function</i>, <i>ritual</i> and <i>myth</i>, please put the images below into their representative columns — as you see fit.</h3>
          ...
          <div class="row"> 
            ...
            <div class="col-10 col-md-6">
              <ol class="sorting function" id="submit">
                ...
                <p class="background text-muted">Drop Function Photos Here</p>
              </ol>

              <ol class="sorting ritual" id="submit">      
                <span class="text-muted label-container">Ritual</span>
                <p class="background text-muted">Drop Ritual Photos Here</p>
              </ol>
            
              <ol class="sorting myth" id="submit">
                <span class="text-muted label-container">Myth</span>
                <p class="background text-muted">Drop Myth Photos Here</p>
              </ol>
            </div>
